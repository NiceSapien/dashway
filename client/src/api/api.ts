...
const api = {
  request: (config: AxiosRequestConfig) => localApi.request(config),
  get: (url: string, config?: AxiosRequestConfig) => localApi.get(url, config),
  post: (url: string, data?: any, config?: AxiosRequestConfig) => localApi.post(url, data, config),
  put: (url: string, data?: any, config?: AxiosRequestConfig) => localApi.put(url, data, config),
